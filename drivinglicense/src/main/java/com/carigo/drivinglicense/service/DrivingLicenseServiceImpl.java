...
public class DrivingLicenseServiceImpl implements DrivingLicenseService {
    ...
    public DrivingLicenseServiceImpl(DrivingLicenseRepository repo,
            DlKycHistoryRepository historyRepo,
    ...
    // ---------------------------------------------------------
    @Override
    public DrivingLicenseDto add(AddDrivingLicenseRequest req) throws IOException {
        ...
        DrivingLicenseEntity dl = DrivingLicenseMapper.toEntity(req);
